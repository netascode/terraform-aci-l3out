...
| <a name="input_import_route_control_enforcement"></a> [import\_route\_control\_enforcement](#input\_import\_route\_control\_enforcement) | L3 Import Route-Control Enforcemente. | `bool` | `false` | no |
| <a name="input_export_route_control_enforcement"></a> [export\_route\_control\_enforcement](#input\_export\_route\_control\_enforcement) | L3 Export Route-Control Enforcemente. | `bool` | `true` | no |
